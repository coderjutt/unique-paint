...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/banner.png);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
	    ...
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/5786106.png);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/banner4.png);">
				<h5 class="contentss">We should wear cotton clothes and light coloured clothes in summers. </br>
Cotton is a good absorber of water. </br>Since we sweat a lot in summers, cotton clothes absorb sweat from 
					our body and exposes the sweat to the atmosphere,</br> making its evaporation faster.</h5>
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/banner5.png);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">20 Day Money Back Guarantee.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over Rs. 300.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">All items-sale up to 50% off </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#cement" data-toggle="tab">cement</a></li>
					<li><a href="#Paint" data-toggle="tab">Piant</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">oors</h3>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Cement</h3>
